...
export const metadata: Metadata = {
  ...
  description:
    'ICF PCC coach with 700+ coaching hours and 110+ professionals across 20+ countries. 10 years in Talent & Leadership Development. Why I coach professionals in transition.',
          ...
          <div className="space-y-6 text-stone-600 leading-relaxed">
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              ...
              <div className="bg-stone-50 p-6 border border-stone-200">
                ...
                <p className="text-stone-700">700+ coaching hours with 110+ professionals</p>
            ...
            <div className="mt-8">
              ...
              <p className="text-stone-600">
                10 years in Talent &amp; Leadership Development, working with professionals
