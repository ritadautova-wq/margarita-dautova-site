    ...
    <>
      ...
      <section className="pt-32 pb-16 md:pt-44 md:pb-28 bg-gradient-to-b from-stone-100/50 to-stone-50">
        <Container size="narrow" className="text-center">
          ...
          <div className="mt-6 space-y-4 text-body-lg text-stone-600 max-w-2xl mx-auto text-pretty">
            <p>
              Restructuring. New roles. Shifting responsibilities. Internal mobility. A team coming
              together after significant change.
            </p>
            <p>
              From an organizational perspective, these may be business decisions. For the people
              experiencing them, they can mean uncertainty, loss, opportunity, questions about
              identity, and a need to rethink what comes next.
            </p>
            <p>
              I design tailored workshops, facilitation sessions and coaching programs that help
              people make sense of change, reconnect with their strengths, and find practical ways
              forward.
            </p>
          </div>
          <div className="mt-10">
      ...
      <section className="section-padding bg-stone-50">
        <Container size="default">
          ...
          <div className="max-w-3xl mx-auto bg-white border border-stone-200 rounded-sm p-6 md:p-10">
            ...
            <h3 className="mt-8 text-sm font-medium text-primary-600 uppercase tracking-wider">
