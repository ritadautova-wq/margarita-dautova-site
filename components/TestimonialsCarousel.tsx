...
export default function TestimonialsCarousel({ variant = 'light' }: TestimonialsCarouselProps) {
  ...
  const cardBg = variant === 'light' ? 'bg-white' : 'bg-stone-50'
  const buttonBg = variant === 'light' ? 'bg-white' : 'bg-white'
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="relative">
        ...
        <button
          onClick={goToPrev}
          className={`absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 md:-translate-x-12 z-10 w-10 h-10 flex items-center justify-center ${buttonBg} border border-stone-200 rounded-full text-stone-400 hover:text-stone-600 hover:border-stone-300 transition-all duration-200`}
        ...
        <button
          onClick={goToNext}
          className={`absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 md:translate-x-12 z-10 w-10 h-10 flex items-center justify-center ${buttonBg} border border-stone-200 rounded-full text-stone-400 hover:text-stone-600 hover:border-stone-300 transition-all duration-200`}
          ...
          >
            <div className="flex">
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <div className={`${cardBg} p-8 md:p-12 border border-stone-200 rounded-sm`}>
